...
#    Updated: 2018/05/23 10:20:48 by alecott          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ALL_ASM_SRCS = ft_verify_label.c op.c ft_get_in_chain.c ft_is_an_error.c ft_parsing.c ft_pass_comment.c main.c ft_asm.c
